...
with col3:
    st.image("https://cdn.pixabay.com/photo/2024/02/28/07/42/european-shorthair-8601492_1280.jpg", caption="AI Generated Cat", width=600)
with col4:
    st.image("catai.png", caption="AI Generated Cat", width=600)
