...
with tab2:
    ...
    st.write("Essentially, they learn to identify the "telltale signs" of AI-created imagery by analyzing pixel data and identifying irregularities that wouldn't naturally occur in a real photograph")
