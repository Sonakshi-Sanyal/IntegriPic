...
with tab2:
    ...
    st.write("IntegriPic is an AI image detector. It works by analyzing an image for patterns and characteristics that are typically found in AI-generated images, like unusual textures, inconsistent lighting, or digital artifacts, comparing them to a database of known "real" images to determine if the image is likely generated by an AI model; essentially, they learn to identify the "telltale signs" of AI-created imagery by analyzing pixel data and identifying irregularities that wouldn't naturally occur in a real photograph")
